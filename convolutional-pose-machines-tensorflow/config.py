...
#     kalman_noise = 0.03
    ...
    bg_img_dir = ''
    pretrained_model = 'cpm_model-24000'
    batch_size = 5
    init_lr = 0.0005
    lr = 0.0005#0.001
    lr_decay_rate = 0.5
    ...
    lr_decay_step = 10000
    l_decay_step = 10000
    training_iters = 28000 #100 #30000 #300000
    verbose_iters = 10
    validation_iters = 500 #50 #1000 
    model_save_iters = 2000 #100 #5000 
    intermediate_showing = 100
    ...
    For Freeze graphs
    """
    output_node_names = 'Stage_6/mid_conv9/BiasAdd:0'
